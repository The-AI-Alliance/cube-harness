"""WAA × Tool 2 (Screenshot only → 13 discrete actions) × GPT-5.4-nano (Azure)."""

import os

# gpt-5.4-nano (and -mini) reject `tool_choice`; drop unsupported params silently.
...
EXP_NAME = "waa_screenshot_13actions_gpt54nano"
