"""WAA × Tool 2 (Screenshot only → 13 discrete actions) × Claude Sonnet 4.6 (Genny2)."""
...
EXP_NAME = "waa_screenshot_13actions_sonnet_v2"
...
def main() -> None:
    ...
    try:
        ...
        print(
            f"Model: {MODEL_NAME} (Genny2, set_cache_control=auto), n_cpus=50, max_steps=100, action_space=computer_13"
        )
        run_with_ray(exp, n_cpus=30, max_retry_rounds=1)
    finally:
        print("\n--- post-run cleanup ---")
