...
def run_xray(
    ...
    def _load_and_build_hierarchy() -> tuple[str, Any, Any, Any, StepId, gr.Tab, gr.Tab, gr.Tab, str, str]:
        ...
        if not seed_rows:
            ...
            return exp_stats, agent_table_data, task_table_data, _rows_to_table(seed_rows), StepId(), *tab_labels, *state.get_config_jsons()
        ...
        tab_labels = _make_tab_labels(agent_rows, task_rows, seed_rows)
        return exp_stats, agent_table_data, task_table_data, seed_table_data, StepId(step=0), *tab_labels, *state.get_config_jsons()
