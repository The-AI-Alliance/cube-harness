...
class AgentOutput(TypedBaseModel):
    ...
    # All LLM calls made during this step. Use LLMCall.id as a meaningful string
    # identifier for each call type (e.g. "act", "summary"). The XRay viewer groups
    # calls by id and renders each group as a separate tab.
