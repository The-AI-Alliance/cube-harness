...
class frozen_partial:
    ...
    def __init__(self, func: callable, **frozen_kwargs) -> None:
        self.func = func
...
def register_task(
    ...
    **kwargs,
    ...
    if task_kwargs is None:
        task_kwargs = {}
    if default_task_kwargs is None:
        default_task_kwargs = {}
    ...
    gym.register(
        id=f"browsergym/{id}",
        entry_point=lambda *env_args, **env_kwargs: BrowserEnv(task_entrypoint, *env_args, **env_kwargs),
