...
def test_max_episode_steps() -> None:
    # no max_steps
    env = gym.make(
        "browsergym/openended",
        task_kwargs={"start_url": TEST_PAGE},
...
def test_nested_iframes_default_demo_mode() -> None:
    demo_mode = "default"
...
def test_resizeable_window(resizeable_window: bool, size: tuple) -> None:
    env = gym.make(
        "browsergym/openended",
        task_kwargs={"start_url": TEST_PAGE},
        headless=__HEADLESS,
