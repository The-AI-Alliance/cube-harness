"""Tests for high-level action set."""
...
def test_click_through_frames() -> None:
    action_set = HighLevelActionSet()
...
def test_fill_through_iframe() -> None:
    action_set = HighLevelActionSet()
...
def test_forced_actions(retry_with_force: bool) -> None:
